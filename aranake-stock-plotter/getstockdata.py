...
def getstockdata(stock):
    ...
    #api_call_string = "%s/%s.json?start_date=%s&end_date=%s"%(url_prefix,stock,startdate,today)
    api_call_string = "http://www.stanford.edu/~aniket/GOOG.json"
    print api_call_string
    
    # Grab the data from Quandl 
    r         = requests.get(api_call_string)
